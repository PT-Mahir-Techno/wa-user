...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
      ...
      <span class="ms-1 font-weight-bold">WA</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0">
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: 65%;">
    <ul class="navbar-nav">
  ...
  <div class="sidenav-footer mx-3 mp-5">
    <a class="btn bg-gradient-primary mt-3 w-100" data-bs-toggle="modal" data-bs-target="#exampleModal">Logout</a>
  </div>
</aside>